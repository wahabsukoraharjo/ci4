...
<form action="/products/update/<?= $product['id']; ?>" method="post" enctype="multipart/form-data">
    <thead>
        <tr>
            <th><label for="product_name">Nama Produk</label></th>
            <th><input type="text" name="product_name" id="product_name" value="<?= esc($product['product_name']); ?>" required></th>
        </tr><br>
        <tr>
        ...
        <tr>
            <th><label for="product_image">Upload Product Image:</label></th>
            <th><input type="file" name="product_image" id="product_image" value="<?= esc($product['image']); ?>" required></th>
            <th><img src="<?= base_url('uploads/' . $product['image']); ?>" width="100"></th>
        </tr><br>
        <tr>
